...
if DIST_VERSION.startswith("kali-rolling"):    LLVMVERSION=21;     GCCVERSION=15; LIBCLC_PACKAGES=["libclc-21-dev"]  # Kali
elif DIST_VERSION.startswith("Kali_2025.3"): LLVMVERSION=21;    GCCVERSION=15; LIBCLC_PACKAGES=["libclc-21-dev"] # Forky / kali
elif DIST_VERSION == "Debian_testing":     LLVMVERSION=21;    GCCVERSION=15; LIBCLC_PACKAGES=["libclc-21-dev"] # currrently Forky
